CREATE TYPE "public"."order_status" AS ENUM('pending', 'cancelled');--> statement-breakpoint
...
CREATE UNIQUE INDEX "inventory_product_unique" ON "inventory" USING btree ("product_id");--> statement-breakpoint
