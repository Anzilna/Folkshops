...
**Not built yet anywhere:** categories/inventory/cart/orders **UI** (backend is done, see above); storefront OTP UI, marketing site content; `RolesGuard`/`@Roles()` enforcement (see Deferred).
